...
from ecom_app.models import NavbarModel, Settings, Footer, ProductModel,\
     CategoryModel, ContactModel, ContactDetailsModel,\
     Banner, MenProduct,  WomenProduct,SportsProduct,ElectronicsProduct,\
     RedCard, Latest_Blog, ClientBrand
