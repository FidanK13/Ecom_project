...
from ecom_app.models import ContactDetailsModel, ContactModel, NavbarModel, Settings, Footer, ProductModel, Category, Banner, MenProduct,  WomenProduct,SportsProduct,ElectronicsProduct, RedCard, Latest_Blog, ClientBrand
